                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="./index.php" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="../assets/images/logos/baner-2048x260.jpg" width="400" alt="">
                                </a>
                                <p class="text-center">Silakan Lengkapi Data Berikut</p>
                                <form action="proses_register.php" method="post">
                                    <div class="mb-3">
                                        <label for="exampleInputtext1" class="form-label">Username</label>
                                        <input type="text" name="username" required maxlength="10" class="form-control" id="exampleInputtext1" aria-describedby="textHelp">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">No Telpon / No WA</label>
                                    ...
                                    <button type="submit" name="daftar" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Sign Up</button>
